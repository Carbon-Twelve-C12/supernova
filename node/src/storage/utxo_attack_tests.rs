...
mod tests {
    ...
    fn test_inflation_attack_prevention() {
        ...
        let tx2 = create_transaction(vec![(outpoint1, 600)], vec![600]);
        ...
        for attacker_id in 0..10 {
            ...
            let handle = thread::spawn(move || {
                ...
                for i in 0..5 {
                    ...
                    if utxo_set_clone
                        .process_transaction(&tx, 2 + i as u64, false)
                        .is_ok()
                    {
                        successful_spends += 1;
                    }
    ...
    fn test_interleaved_operations() {
        ...
        handles.push(thread::spawn(move || {
            ...
            for i in (0..20).step_by(2) {
                let tx = create_transaction(vec![(OutPoint::new([i; 32], 0), 100)], vec![50, 50]);
        ...
        handles.push(thread::spawn(move || {
            ...
            for i in (1..20).step_by(2) {
                let tx = create_transaction(vec![(OutPoint::new([i; 32], 0), 100)], vec![60, 40]);
