...
impl NodeTestnetManager {
    ...
    pub async fn request_faucet_coins(&self, recipient: &str) -> Result<FaucetDistributionResult, FaucetError> {
        ...
        info!("Faucet distributed {} NOVA to {}", amount as f64 / 100_000_000.0, recipient);
    ...
    pub fn process_test_block(&self, height: u64, timestamp: u64, miner: Option<String>) -> Result<(), String> {
        // Update core manager
    ...
    pub fn simulate_network_conditions(
        ...
        info!("Simulating network conditions: latency={}ms, packet_loss={}%", 
...
mod tests {
    ...
    async fn test_stats_tracking() {
        ...
        manager.process_test_block(1, 1234567890, Some("test_miner".to_string())).unwrap();
