...
impl Amount {
    ...
    pub fn checked_add(&self, other: Self) -> Option<Self> {
        self.attonovas.checked_add(other.attonovas).map(Self::from_attonovas)
    }
    
    /// Subtract two amounts
    pub fn checked_sub(&self, other: Self) -> Option<Self> {
        self.attonovas.checked_sub(other.attonovas).map(Self::from_attonovas)
    }
    
    /// Multiply by a scalar
    pub fn checked_mul(&self, scalar: u64) -> Option<Self> {
        self.attonovas.checked_mul(scalar as u128).map(Self::from_attonovas)
    }
...
mod tests {
    ...
    fn test_nova_unit_formatting() {
        ...
        assert_eq!(amount.format_with_unit(NovaUnit::MicroNova), "1500000 μNOVA");
    ...
    fn test_amount_arithmetic() {
        ...
        assert_eq!(tiny_a.checked_add(tiny_b), Some(Amount::from_attonovas(150)));
    ...
    fn test_display() {
        ...
        assert_eq!(Amount::from_nova(0.000000001).to_string(), "0.000000001000000000 NOVA");
        assert_eq!(Amount::from_unit(1.0, NovaUnit::AttaNova).unwrap().to_string(), 
        ...
        assert_eq!(FeeRate::from_attonovas_per_byte(100).to_string(), "100 attonovas/byte");
    }
} 