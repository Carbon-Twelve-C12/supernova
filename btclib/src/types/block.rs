...
impl Block {
    ...
    pub fn size(&self) -> usize {
        ...
        let tx_sizes: usize = self.transactions
            .iter()
...
impl fmt::Display for Block {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        write!(f, "Block {{ hash: {}, height: N/A, tx_count: {} }}", 
...
impl network_protocol::Block {
    ...
    pub fn to_core_block(&self) -> Block {
        ...
        let header = BlockHeader::new(
            ...
            [0; 32], // merkle_root
            SystemTime::now().duration_since(UNIX_EPOCH).unwrap().as_secs(), // timestamp
            0x1d00ffff, // bits
            0, // nonce
        );
...
mod tests {
    ...
    fn test_nonce_increment() {
        let mut header = BlockHeader::new(1, [0u8; 32], [0u8; 32], 
