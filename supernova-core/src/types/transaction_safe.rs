...
mod tests {
    ...
    fn test_calculate_fee_safe() {
        ...
        let get_output = |_: &[u8; 32], _: u32| Some(TransactionOutput::new(60_000_000, vec![]));
    ...
    fn test_validate_safe_with_overflow() {
        ...
        let get_output = |_: &[u8; 32], _: u32| Some(TransactionOutput::new(100_000, vec![]));
