use super::{
    ENV_BONUS_EFFICIENCY, ENV_BONUS_MAX_TOTAL, ENV_BONUS_RENEWABLE, HALVING_INTERVAL, MAX_HALVINGS,
    NOVA_BLOCK_REWARD,
};
...
mod tests {
    ...
    fn test_environmental_bonus() {
        ...
        assert_eq!(
            calculate_environmental_bonus(base_reward, &unverified_profile),
            0
        );
        ...
        assert_eq!(
            calculate_environmental_bonus(base_reward, &renewable_profile),
            10 * 100_000_000
        ); // 10 NOVA
        ...
        assert_eq!(
            calculate_environmental_bonus(base_reward, &combined_profile),
            17_50000000
        ); // 17.5 NOVA (35% bonus)
        ...
        assert_eq!(
            calculate_environmental_bonus(base_reward, &partial_profile),
            7_50000000
        ); // 7.5 NOVA (15% bonus)
    }
    ...
    fn test_total_issued() {
        ...
        assert_eq!(
            calculate_total_issued(HALVING_INTERVAL * 2),
            second_era_total
        );
    }
}
