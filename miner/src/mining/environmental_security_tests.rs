use super::environmental_verification::{
    EfficiencyAudit, EnvironmentalVerifier, RECCertificate, VerificationError,
};
...
mod environmental_security_tests {
    ...
    async fn test_expired_certificate_rejection() {
        ...
        verifier
            .register_rec_certificate(expired_cert.clone())
            .await;
        ...
        assert!(result.is_ok());
        assert_eq!(
            result.unwrap().environmental_profile.renewable_percentage,
            0.0
        );
    }
    ...
    async fn test_certificate_tampering_detection() {
        ...
        verifier
            .register_rec_certificate(original_cert.clone())
            .await;
